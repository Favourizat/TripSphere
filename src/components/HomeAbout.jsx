...
const HomeAbout = () => {
    return (
        <section className="bg-white px-4 py-14 sm:px-6 sm:py-16 md:px-10 lg:px-20 lg:py-20">
            <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 sm:gap-12 lg:flex-row lg:gap-16">
                ...
                <div className="w-full lg:w-1/2">
                    <img
                        ...
                        className="h-[320px] w-full rounded-2xl object-cover shadow-xl sm:h-[400px] sm:rounded-3xl md:h-[450px] lg:h-[500px]"
                    />
                </div>
                ...
                <div className="w-full max-w-2xl lg:w-1/2">
                    ...
                    {/* Button */}
                    <button
                        className="mt-8 w-full rounded-full bg-blue-600 px-8 py-3.5 font-semibold text-white shadow-md transition duration-300 hover:bg-blue-700 hover:shadow-lg sm:mt-10 sm:w-auto sm:py-4"
                    >
                        Book Now
                    </button>
